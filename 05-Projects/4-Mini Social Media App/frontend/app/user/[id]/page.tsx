  ...
  return (
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
        {posts.map(post => (
          <div key={post.id} className="border-black shadow-md overflow-hidden flex flex-col">
            ...
            <div className="p-3 flex flex-col flex-1">
              ...
              <a href="#" className="text-[#261CC1] font-medium mt-auto hover:underline text-sm">Read more</a>
            </div>
          </div>
        ))}
      </div>
